...
function criandoBotaoHoliday(botaonome){
  let botao= document.getElementsByClassName("buttons-container")[0]
  ...
  novoBotao.innerHTML= botaonome;
  botao.appendChild(novoBotao)
}

criandoBotaoHoliday("Feriados");
